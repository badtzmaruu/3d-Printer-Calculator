      ...
      pw.Page(
        build: (pw.Context context) => pw.Column(
          children: <pw.Widget>[
            ...
            pw.Text('Total Cost: '+ totalCostString),
            pw.Text('Material Cost Subtotal: '+ materialCostSubtotalString),
            pw.Text('Print Cost Subtotal: '+ printCostSubtotalString),
            pw.Text('Electricity Cost Subtotal: '+ electricityCostSubtotalString),
            pw.Text('Labour Cost Subtotal: '+ labourCostSubtotalString),
            pw.Text('Equipment Cost Subtotal: '+ equipmentCostSubtotalString),
            pw.Text('Waste Cost Subtotal: '+ wasteCostSubtotalString),
            pw.Text('Failed Print Cost Subtotal: '+ failedPrintCostSubtotalString),
            pw.Text('Processing Cost Subtotal: '+ processingCostSubtotalString),
          ],
        ),
      ),
    );
